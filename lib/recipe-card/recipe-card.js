...
class RecipeCard extends HTMLElement {
  ...
  async _fetchRecipeImage() {
      if (!this._recipeData?.category || !this._recipeData?.image) {
          return;
      }
      ...
      try {
          ...
          this._imageUrl = '../img/placeholder.jpg';
      }
  }
  ...
  _renderRecipe() {
    const { name, category, cookingTime, difficulty } = this._recipeData;
            ...
            <div class="recipe-content">
                ...
                <div class="recipe-details">
                    <div class="recipe-meta">
                        <span>זמן הכנה: ${this._formatCookingTime(cookingTime)}</span>
