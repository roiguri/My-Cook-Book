 ...
 * 
 * This component creates a customizable modal dialog that can be easily integrated into web pages.
 * It provides a flexible, accessible, and stylable modal with open/close functionality and event handling.
 * 
 * Features:
 * - Easy to integrate with any web page
 * - Customizable width, height, and background color
 * - Accessible keyboard navigation (Tab key) and Escape key to close
 * - Animated opening and closing
 * - Event dispatching for opened and closed states
 * - Scroll locking of the main page when modal is open
 * 
 * How to use:
 ...
 *    </custom-modal>
 * 
 * 3. Use JavaScript to open and close the modal:
 *    const modal = document.querySelector('custom-modal');
 *    modal.open();  // Opens the modal
 *    modal.close(); // Closes the modal
 * 
 * 4. Listen for modal events:
 *    modal.addEventListener('modal-opened', () => console.log('Modal opened'));
 *    modal.addEventListener('modal-closed', () => console.log('Modal closed'));
 * 
 * 5. Customize the modal appearance using attributes:
 *    <custom-modal width="400px" height="300px" background-color="#f0f0f0">
 *      <!-- Your modal content -->
 *    </custom-modal>
 * 
 * Examples:
 ...
 * 
 * Customized modal:
 * <custom-modal id="customModal" width="500px" height="400px" background-color="#e0e0e0">
 *   <h2>Customized Modal</h2>
 *   <p>This modal has custom dimensions and background color.</p>
 *   <button onclick="document.getElementById('customModal').close()">Close</button>
 * </custom-modal>
 * 
 * <button onclick="document.getElementById('customModal').open()">Open Custom Modal</button>
 * 
 * Event handling:
 * <script>
 *   const eventModal = document.getElementById('eventModal');
 *   eventModal.addEventListener('modal-opened', () => console.log('Modal was opened'));
 *   eventModal.addEventListener('modal-closed', () => console.log('Modal was closed'));
 * </script>
 */
