class RecipeFormComponent extends HTMLElement {
  constructor() {
    ...
    if (this.hasAttribute('clear-button-text')){
      this.clearButtonText = this.getAttribute('clear-button-text'); 
    } else {
      this.clearButtonText = 'נקה';  
    }
    if (this.hasAttribute('submit-button-text')){
      this.submitButtonText = this.getAttribute('submit-button-text'); 
    } else {
      this.submitButtonText = 'שלח מתכון';
    }
  }
