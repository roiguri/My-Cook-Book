class RecipeFormComponent extends HTMLElement {
  ...
  setupEventListeners() {
    ...
    const form = this.shadowRoot.querySelector('.recipe-form__button--submit');
  ...
  handleSubmit(event) {
    ...
    if (!this.validateForm()) {
      ...
      this.shadowRoot.querySelector(".recipe-form__error-message").style.display = "block";
      return;
    }
  ...
  submitRecipe() {
    ...
    // You would typically collect all the form data and send it to a server here
  }
}
