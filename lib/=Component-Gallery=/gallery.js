...
class ComponentGallery {
  ...
  async loadComponentContent(componentName, section) {
      try {
          // Load component HTML
          const response = await fetch(`components/${componentName}/modal-demo.html`);
  ...
  async loadComponentScript(componentName) {
      ...
      script.src = `components/${componentName}/modal-demo.js`;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  window.gallery.showComponent('modal');
});