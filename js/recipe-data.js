...
const recipes = [
    ...
    // Stir-Fried Pasta with Salmon
    {
        ...
        ingredients: [
            ...
            { item: "אבקת צ'ילי", amount: 1, unit: "כפית" },
            { item: "שעועית ירוקה עדינה", amount: 200, unit: "גרם" },
            { item: "ברוקולי", amount: 1, unit: "ראש" },
            { item: "אטריות אורז/חיטה", amount: 250, unit: "גרם" },
        ...
        stages: [
            {
                ...
                instructions: [
                    ...
                    "מערבבים הכל, סוגרים את המכסה ושמים על אש בינונית עד שגזר והשעועית אל דנטה - בערך 10 דקות."
                ]
            },
            {
                title: "הכנת האורז",
        ...
        stages: [
            ...
            },
            {
                ...
                instructions: [
                    ...
                    "ניתן להשאיר על האש עד כשעה לקבלת תאגיד!"
                ]
            }
        ]
    },
